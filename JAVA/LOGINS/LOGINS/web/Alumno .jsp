...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <a  style = "color:white"class="navbar-toggler"><span class ="navbar-toggler-icon"> </span> Alumno</a>
            <div class = "dropdown">
        ...
        <div class="container mt-4">
            <h1>Bienvenido al Menú Alumno <strong>${nom}</strong></h1>
        </div>
        ...
        <div>
                <form action = "Controlador" method = "POST">
                   <br> ID:        <input type="text" name ="txtId"> <br>
                    ...
                    <input type="submit" name="accion" value="Guardar Alumno">
                </form> 
        </div>
  <div>
 <form action="Controlador" method="POST">
                <input type="submit" name="accion3" value="Listar Alumno">
                   </form>
            <div>
