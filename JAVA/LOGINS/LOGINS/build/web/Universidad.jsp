...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <a  style = "color:white"class="navbar-toggler"><span class ="navbar-toggler-icon"> </span> Universidad</a>
            <div class = "dropdown">
        ...
        <div class="container mt-4">
            <h1>Bienvenido al Menú Universidad: <strong>${nom}</strong></h1>
        </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
        <div>
                <form action = "Controlador" method = "POST">
                    ...
                    <input type="submit" name="accion" value="GuardarUniversidad">
                </form> 
        </div>
  <div>
 <form action="Controlador" method="POST">
                <input type="submit" name="accion3" value="Listar">
                   </form>
            <div>
