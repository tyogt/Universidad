...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <a  style = "color:white"class="navbar-toggler"><span class ="navbar-toggler-icon"> </span> Catedratico</a>
            <div class = "dropdown">
        ...
        <div class="container mt-4">
            <h1>Bienvenido al Menú Catedratico <strong>${nom}</strong></h1>
        </div>
        ...
        <div>
                <form action = "Controlador" method = "POST">
                   <br> ID:        <input type="text" name ="txtId"> <br>
                    ...
                    <br>Edad:  <input type="text" name ="txtEdad"> 
                     <br>Genero:  <input type="text" name ="txtGenero"> 
               
                    
                                    
                    <input type="submit" name="accion" value="Guardar Catedratico">
                </form> 
        </div>
  <div>
 <form action="Controlador" method="POST">
                <input type="submit" name="accion3" value="Listar Catedraticos">
                   </form>
            <div>
