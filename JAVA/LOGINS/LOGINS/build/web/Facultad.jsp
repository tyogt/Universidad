...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <a  style = "color:white"class="navbar-toggler"><span class ="navbar-toggler-icon"> </span> Facultad</a>
        ...
        <div class="container mt-4">
            <h1>Bienvenido al Menú Facultad <strong>${nom}</strong></h1>
        </div>
        ...
        <div>
                <form action = "Controlador" method = "POST">
                   <br> ID:        <input type="text" name ="txtId"> <br>
                    ...
                    <br>Nombre Coordinador:  <input type="text" name ="txtCoordinador"> 
               
                    
                                    
                    <input type="submit" name="accion" value="Guardar Facultad">
                </form> 
        </div>
  <div>
 <form action="Controlador" method="POST">
                <input type="submit" name="accion3" value="Listar Facultades">
                   </form>
            <div>
