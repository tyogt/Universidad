...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark">
            <a  style = "color:white"class="navbar-toggler"><span class ="navbar-toggler-icon"> </span> Asignacion Curso</a>
            <div class = "dropdown">
        ...
        <div class="container mt-4">
            <h1>Bienvenido a la Asignación de Curso <strong>${nom}</strong></h1>
        </div>
        ...
        <div>
                <form action = "Controlador" method = "POST">
                   <br> ID:        <input type="text" name ="txtId"> <br>
                     Asignación:  <input type="text" name ="txtNombre"> 
                    <br>IdCurso:  <input type="text" name ="txtEdad"> 
                     <br>Sección:  <input type="text" name ="txtGenero"> 
               
                    
                                    
                    <input type="submit" name="accion" value="Guardar Asignacion">
                </form> 
        </div>
  <div>
 <form action="Controlador" method="POST">
                <input type="submit" name="accion3" value="Listar Asignaciones">
                   </form>
            <div>
